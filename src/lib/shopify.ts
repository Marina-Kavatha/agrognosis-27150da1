...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'the-agrolab-collective-q75aj.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = '6f4e77424e3e39f2aa7ec88462e42a9d';
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: Απαιτείται πληρωμή", {
      description: "Η πρόσβαση στο Shopify API απαιτεί ενεργό πρόγραμμα πληρωμών.",
    });
    return;
  }
