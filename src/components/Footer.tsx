      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <h3 className="font-display text-2xl mb-4">Agrognosis</h3>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-accent-foreground/70">
              <a href="mailto:info.agrognosis@gmail.com" className="hover:text-accent-foreground transition-colors">info.agrognosis@gmail.com</a>
        ...
        <div className="mt-16 pt-8 border-t border-accent-foreground/10">
          <p className="text-xs text-accent-foreground/40">
            © {new Date().getFullYear()} Agrognosis. Με επιφύλαξη παντός δικαιώματος.
          </p>
        </div>
      </div>
    </footer>
